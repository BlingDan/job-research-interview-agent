...
class DbStateService:
    ...
    def task_dir(self, task_id: str) -> Path:
        path = self.db_path.parent / "task_files" / task_id
    ...
    def list_tasks(
        ...
        try:
            ...
            conn.close()
        return [AgentPilotTask.model_validate(json.loads(row["data_json"])) for row in rows]
...
class StateService(DbStateService):
    """Backwards-compatible alias for legacy callers during migration."""
