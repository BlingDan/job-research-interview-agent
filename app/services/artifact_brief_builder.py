...
OFFICIAL_REQUIREMENT_MAPPING: dict[str, str] = {
    ...
    "C": "文档与画板生成：Doc Agent 输出参赛方案，Canvas Agent 输出架构/流程画板。",
    "D": "演示材料生成：Presentation Agent 生成 5 页答辩汇报材料。",
...
def build_artifact_brief(task: AgentPilotTask) -> ArtifactBrief:
    ...
    must_have_points = [
        "清晰覆盖官方 A-F 场景，让评委一眼看到 IM 入口、规划、生成、协同和交付闭环。",
    ...
    return ArtifactBrief(
        ...
        feishu_suite_linkage=[
            ...
            "飞书 Doc：结构化沉淀参赛方案、A-F 映射、工程实现和演示脚本。",
            "飞书 Slides：将方案压缩成 5 页答辩路径，突出价值、架构、协同、落地。",
        ...
        engineering_implementation_points=[
            ...
            "fake/dry-run artifact 保证权限不足时比赛演示不中断。",
        ],
        demo_script=[
            "在飞书测试群发送 @Agent 参赛任务。",
